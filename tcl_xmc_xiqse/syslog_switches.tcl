...
set var VAR_FINAL "Fim do Scripts"
...
#limpeza do que ja existe
    ...
    CLI info-center loghost $VAR_SRV_XMC5 facility local0
    CLI info-center loghost $VAR_SRV_XIQS facility local0
    CLI info-center loghost $VAR_SRV_XMC5 channel loghost level information
    CLI info-center loghost $VAR_SRV_XIQS channel loghost level information
    #CLI info-center loghost $VAR_SRV_SIEM channel loghost level information
